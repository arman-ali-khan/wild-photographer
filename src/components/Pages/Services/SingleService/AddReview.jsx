...
const AddReview = ({id}) => {
    ...
    const notify = () => toast.success("Review Submit!");
  ...
  <div className="flex flex-col items-center w-full">
      ...
      <div className="flex flex-col w-full">
       ...
       <input name='reviewerPhoto' className='p-4 w-full flex justify-center  mx-auto border-4 rounded-md resize-none text-gray-800 bg-gray-50' type='url' defaultValue={user?.photoURL? user?.photoURL : '' } placeholder='Add Photo Url'  required/>
        ...
        <textarea name='review' rows="3" cols='49' placeholder="Message..." className="p-4 flex justify-center md:w-1/2 mx-auto border-4 rounded-md resize-none text-gray-800 bg-gray-50" required></textarea>
